...
private func beforeEachGenerate() -> ([Type], [String: AnnotationValue]) {
    ...
    complexType.rawMethods = [
        Function(name: "foo(some: Int)", selectorName: "foo(some:)", parameters: [FunctionParameter(name: "some", typeName: TypeName(name: "Int"))], accessLevel: .public, definedInTypeName: TypeName(name: "Complex")),
        Function(name: "foo2(some: Int)", selectorName: "foo2(some:)", parameters: [FunctionParameter(name: "some", typeName: TypeName(name: "Float"))], isStatic: true, definedInTypeName: TypeName(name: "Complex")),
        Function(name: "foo3(some: Int)", selectorName: "foo3(some:)", parameters: [FunctionParameter(name: "some", typeName: TypeName(name: "Int"))], isClass: true, definedInTypeName: TypeName(name: "Complex"))
    ]
    ...
    complexTypeExtension.rawMethods = [
        Function(name: "fooFromExtension(some: Int)", selectorName: "fooFromExtension(some:)", parameters: [FunctionParameter(name: "some", typeName: TypeName(name: "Int"))], definedInTypeName: TypeName(name: "Complex")),
        Function(name: "foo2FromExtension(some: Int)", selectorName: "foo2FromExtension(some:)", parameters: [FunctionParameter(name: "some", typeName: TypeName(name: "Float"))], definedInTypeName: TypeName(name: "Complex"))
    ]
    ...
    let knownProtocol = Protocol(name: "KnownProtocol", variables: [
        ...
        Function(name: "foo(some: String)", selectorName: "foo(some:)", parameters: [FunctionParameter(name: "some", typeName: TypeName(name: "String"))], accessLevel: .public, definedInTypeName: TypeName(name: "KnownProtocol"))
    ])
...
private extension String {
    func generate() -> String {
        ...
        let (uniqueTypes, _, _) = Composer().compose(functions: [], typealiases: [], types: types)
